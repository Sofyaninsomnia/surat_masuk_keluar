...
class Surat_keluar extends CI_Controller
{
    ...
    {
        $data['surat_keluar'] = $this->SK_model->get();
    ...
    {
        $data['surat_keluar'] = $this->SK_model->get_by_id($id);
    ...
    public function pdf()
    {
        ...
        if ($start_date && $end_date) {
            $data['surat_keluar'] = $this->SK_model->get_filtered($start_date, $end_date);
        } else {
            $data['surat_keluar'] = $this->SK_model->get();
        }

        $this->load->view('surat_keluar/laporan_pdf', $data);
        ...
        $dompdf->render();
        $dompdf->stream("laporan_surat_keluar.pdf", array('attachment'));
    }
      public function search() {
        $keyword = $this->input->post('keyword');
        $data['surat_keluar'] = $this->SK_model->get_keyword($keyword);
        $this->load->view('layout/header');
        $this->load->view('layout/sidebar');
        $this->load->view('surat_keluar/index', $data);
        $this->load->view('layout/footer');
